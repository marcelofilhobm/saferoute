...
js/app.js      ← interface
test/core.test.mjs   ← 43 testes (node --test), fixtures reais do Rio
...
| Rodadas de pedido do desvio | 3 por verificação | `buscaDesvio` |
...
Se o desvio passa por uma área que o motor não recebeu, `buscaDesvio` pede de novo com ela (decisão 021) — caminho maior é aceitável; atravessar área evitável não.
